"""Prepara orders.csv a partir do dataset Online Retail (UCI)."""
import csv
import io
...
OUT = Path(__file__).resolve().parents[1] / "data" / "raw" / "orders.csv"
MAX_ROWS = 5000
...
def main():
    ...
    print(f"Dataset salvo: {OUT} ({len(df):,} pedidos)")
